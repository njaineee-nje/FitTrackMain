          ...
          <div className="bg-gray-900 rounded-xl p-8 text-white">
            ...
            <div className="space-y-3 mb-6">
              <button 
                ...
                className="w-full bg-white text-gray-900 py-3 px-4 rounded-lg font-medium hover:bg-gray-50 transition-colors flex items-center justify-center space-x-3 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isGoogleLoading ? (
